...
const Snapshot$json = {
  ...
  '2': [
    ...
    {'1': 'metadata', '3': 5, '4': 1, '5': 11, '6': '.cosmos.base.snapshots.v1beta1.Metadata', '8': {}, '10': 'metadata'},
  ],
};
...
const SnapshotItem$json = {
  '1': 'SnapshotItem',
  '2': [
    {'1': 'store', '3': 1, '4': 1, '5': 11, '6': '.cosmos.base.snapshots.v1beta1.SnapshotStoreItem', '9': 0, '10': 'store'},
...
final $typed_data.Uint8List snapshotItemDescriptor = $convert.base64Decode(
    ...
    'YXlsb2FkSABSEGV4dGVuc2lvblBheWxvYWRCBgoEaXRlbQ==');
