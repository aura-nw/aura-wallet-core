...
final $typed_data.Uint8List eventGrantDescriptor = $convert.base64Decode(
    ...
    'VyGAMgASgJUgdncmFudGVyEhgKB2dyYW50ZWUYBCABKAlSB2dyYW50ZWU=');
...
final $typed_data.Uint8List eventRevokeDescriptor = $convert.base64Decode(
    'CgtFdmVudFJldm9rZRIgCgxtc2dfdHlwZV91cmwYAiABKAlSCm1zZ1R5cGVVcmwSGAoHZ3Jhbn'
    'RlchgDIAEoCVIHZ3JhbnRlchIYCgdncmFudGVlGAQgASgJUgdncmFudGVl');
