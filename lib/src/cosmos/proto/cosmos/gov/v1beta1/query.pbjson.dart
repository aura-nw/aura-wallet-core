...
final $typed_data.Uint8List queryProposalsRequestDescriptor = $convert.base64Decode(
    ...
    'IAEoCVIFdm90ZXISHAoJZGVwb3NpdG9yGAMgASgJUglkZXBvc2l0b3ISRgoKcGFnaW5hdGlvbh'
    'gEIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRp'
    'b246CIigHwDooB8A');
...
final $typed_data.Uint8List queryVoteRequestDescriptor = $convert.base64Decode(
    'ChBRdWVyeVZvdGVSZXF1ZXN0Eh8KC3Byb3Bvc2FsX2lkGAEgASgEUgpwcm9wb3NhbElkEhQKBX'
    'ZvdGVyGAIgASgJUgV2b3RlcjoIiKAfAOigHwA=');
...
final $typed_data.Uint8List queryDepositRequestDescriptor = $convert.base64Decode(
    'ChNRdWVyeURlcG9zaXRSZXF1ZXN0Eh8KC3Byb3Bvc2FsX2lkGAEgASgEUgpwcm9wb3NhbElkEh'
    'wKCWRlcG9zaXRvchgCIAEoCVIJZGVwb3NpdG9yOgiIoB8A6KAfAA==');
