...
class QueryClient extends $grpc.Client {
  static final _$accounts = $grpc.ClientMethod<$0.QueryAccountsRequest, $0.QueryAccountsResponse>(
      '/cosmos.auth.v1beta1.Query/Accounts',
      ($0.QueryAccountsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.QueryAccountsResponse.fromBuffer(value));
  static final _$account = $grpc.ClientMethod<$0.QueryAccountRequest, $0.QueryAccountResponse>(
      '/cosmos.auth.v1beta1.Query/Account',
      ($0.QueryAccountRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.QueryAccountResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.QueryAccountsResponse> accounts($0.QueryAccountsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$accounts, request, options: options);
  }

  $grpc.ResponseFuture<$0.QueryAccountResponse> account($0.QueryAccountRequest request, {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.QueryAccountsRequest, $0.QueryAccountsResponse>(
        'Accounts',
        accounts_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.QueryAccountRequest, $0.QueryAccountResponse>(
        'Account',
        account_Pre,
        false,
        false,
  ...
  $async.Future<$0.QueryAccountsResponse> accounts_Pre($grpc.ServiceCall call, $async.Future<$0.QueryAccountsRequest> request) async {
    return accounts(call, await request);
  }

  $async.Future<$0.QueryAccountResponse> account_Pre($grpc.ServiceCall call, $async.Future<$0.QueryAccountRequest> request) async {
  ...
  $async.Future<$0.QueryAccountsResponse> accounts($grpc.ServiceCall call, $0.QueryAccountsRequest request);
  $async.Future<$0.QueryAccountResponse> account($grpc.ServiceCall call, $0.QueryAccountRequest request);
