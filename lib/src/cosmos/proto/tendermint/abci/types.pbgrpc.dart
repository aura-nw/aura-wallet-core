...
class ABCIApplicationClient extends $grpc.Client {
  ...
  static final _$setOption = $grpc.ClientMethod<$0.RequestSetOption, $0.ResponseSetOption>(
      '/tendermint.abci.ABCIApplication/SetOption',
      ($0.RequestSetOption value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseSetOption.fromBuffer(value));
  static final _$deliverTx = $grpc.ClientMethod<$0.RequestDeliverTx, $0.ResponseDeliverTx>(
      '/tendermint.abci.ABCIApplication/DeliverTx',
      ($0.RequestDeliverTx value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDeliverTx.fromBuffer(value));
  ...
  static final _$beginBlock = $grpc.ClientMethod<$0.RequestBeginBlock, $0.ResponseBeginBlock>(
      '/tendermint.abci.ABCIApplication/BeginBlock',
      ($0.RequestBeginBlock value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseBeginBlock.fromBuffer(value));
  static final _$endBlock = $grpc.ClientMethod<$0.RequestEndBlock, $0.ResponseEndBlock>(
      '/tendermint.abci.ABCIApplication/EndBlock',
      ($0.RequestEndBlock value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseEndBlock.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ResponseSetOption> setOption($0.RequestSetOption request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setOption, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseDeliverTx> deliverTx($0.RequestDeliverTx request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ResponseBeginBlock> beginBlock($0.RequestBeginBlock request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$beginBlock, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResponseEndBlock> endBlock($0.RequestEndBlock request, {$grpc.CallOptions? options}) {
...
abstract class ABCIApplicationServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ResponseSetOption> setOption_Pre($grpc.ServiceCall call, $async.Future<$0.RequestSetOption> request) async {
    return setOption(call, await request);
  }

  $async.Future<$0.ResponseDeliverTx> deliverTx_Pre($grpc.ServiceCall call, $async.Future<$0.RequestDeliverTx> request) async {
  ...
  $async.Future<$0.ResponseBeginBlock> beginBlock_Pre($grpc.ServiceCall call, $async.Future<$0.RequestBeginBlock> request) async {
    return beginBlock(call, await request);
  }

  $async.Future<$0.ResponseEndBlock> endBlock_Pre($grpc.ServiceCall call, $async.Future<$0.RequestEndBlock> request) async {
  ...
  $async.Future<$0.ResponseSetOption> setOption($grpc.ServiceCall call, $0.RequestSetOption request);
  $async.Future<$0.ResponseDeliverTx> deliverTx($grpc.ServiceCall call, $0.RequestDeliverTx request);
  ...
  $async.Future<$0.ResponseBeginBlock> beginBlock($grpc.ServiceCall call, $0.RequestBeginBlock request);
  $async.Future<$0.ResponseEndBlock> endBlock($grpc.ServiceCall call, $0.RequestEndBlock request);
