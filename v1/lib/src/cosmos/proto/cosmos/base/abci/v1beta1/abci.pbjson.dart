...
final $typed_data.Uint8List aBCIMessageLogDescriptor = $convert.base64Decode(
    'Cg5BQkNJTWVzc2FnZUxvZxIbCgltc2dfaW5kZXgYASABKA1SCG1zZ0luZGV4EhAKA2xvZxgCIA'
    'EoCVIDbG9nElMKBmV2ZW50cxgDIAMoCzIlLmNvc21vcy5iYXNlLmFiY2kudjFiZXRhMS5TdHJp'
    'bmdFdmVudEIUyN4fAKrfHwxTdHJpbmdFdmVudHNSBmV2ZW50czoEgNwgAQ==');
...
final $typed_data.Uint8List gasInfoDescriptor = $convert.base64Decode(
    'CgdHYXNJbmZvEjQKCmdhc193YW50ZWQYASABKARCFfLeHxF5YW1sOiJnYXNfd2FudGVkIlIJZ2'
    'FzV2FudGVkEi4KCGdhc191c2VkGAIgASgEQhPy3h8PeWFtbDoiZ2FzX3VzZWQiUgdnYXNVc2Vk');
...
final $typed_data.Uint8List resultDescriptor = $convert.base64Decode(
    'CgZSZXN1bHQSEgoEZGF0YRgBIAEoDFIEZGF0YRIQCgNsb2cYAiABKAlSA2xvZxI0CgZldmVudH'
    'MYAyADKAsyFi50ZW5kZXJtaW50LmFiY2kuRXZlbnRCBMjeHwBSBmV2ZW50czoEiKAfAA==');
...
final $typed_data.Uint8List txMsgDataDescriptor = $convert.base64Decode(
    'CglUeE1zZ0RhdGESNQoEZGF0YRgBIAMoCzIhLmNvc21vcy5iYXNlLmFiY2kudjFiZXRhMS5Nc2'
    'dEYXRhUgRkYXRhOgSA3CAB');
...
final $typed_data.Uint8List searchTxsResultDescriptor = $convert.base64Decode(
    'Cg9TZWFyY2hUeHNSZXN1bHQSRgoLdG90YWxfY291bnQYASABKARCJereHwt0b3RhbF9jb3VudP'
    'LeHxJ5YW1sOiJ0b3RhbF9jb3VudCJSCnRvdGFsQ291bnQSFAoFY291bnQYAiABKARSBWNvdW50'
    'EkYKC3BhZ2VfbnVtYmVyGAMgASgEQiXq3h8LcGFnZV9udW1iZXLy3h8SeWFtbDoicGFnZV9udW'
    '1iZXIiUgpwYWdlTnVtYmVyEkIKCnBhZ2VfdG90YWwYBCABKARCI+reHwpwYWdlX3RvdGFs8t4f'
    'EXlhbWw6InBhZ2VfdG90YWwiUglwYWdlVG90YWwSFAoFbGltaXQYBSABKARSBWxpbWl0EjYKA3'
    'R4cxgGIAMoCzIkLmNvc21vcy5iYXNlLmFiY2kudjFiZXRhMS5UeFJlc3BvbnNlUgN0eHM6BIDc'
    'IAE=');
