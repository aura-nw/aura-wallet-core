...
class OrderBy extends $pb.ProtobufEnum {
  ...
  static const OrderBy ORDER_BY_ASC = OrderBy._(1, _omitEnumNames ? '' : 'ORDER_BY_ASC');
  static const OrderBy ORDER_BY_DESC = OrderBy._(2, _omitEnumNames ? '' : 'ORDER_BY_DESC');
...
class BroadcastMode extends $pb.ProtobufEnum {
  ...
  static const BroadcastMode BROADCAST_MODE_SYNC = BroadcastMode._(2, _omitEnumNames ? '' : 'BROADCAST_MODE_SYNC');
  static const BroadcastMode BROADCAST_MODE_ASYNC = BroadcastMode._(3, _omitEnumNames ? '' : 'BROADCAST_MODE_ASYNC');
